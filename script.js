...
recognition.onend = function() {
  ...
  listening = false;
  document.getElementById("voice").src = "other/microphone.svg";
...
function voice() {
  if (!listening) {
    ...
    recognition.start();
    listening = true;
    chime = new Audio('other/chime.mp3');
    chime.volume= 0.25;
    chime.play();
    document.getElementById("voice").src = "other/loader.svg";
  ...
  if (result.includes("play")){
    ...
    if (timer != null) {
      ...
      if (counter == 0) {
        ...
        timer = setTimeout(function() {document.getElementById("banner").style.display = "initial";document.getElementById("notification").innerHTML = "BEEP! Your timer is done.";new Audio('other/ringtone.mp3').play();timer=null;setTimeout(function () {document.getElementById('banner').style.display='none'}, 5000)}, amount);
